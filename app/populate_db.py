...
if __name__ == "__main__":
    with SessionLocal() as session:
        ...
        add_param(session, "GM", description="Желаемая маржинальность")
        ...
        update_param_value(session, "DirectCosts", 10)
        ...
        create_purchase(session, 1, 12, 2, 100)
        create_purchase(session, 1, 13, 3, 100)
